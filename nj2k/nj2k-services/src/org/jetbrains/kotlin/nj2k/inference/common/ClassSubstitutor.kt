        ...
        fun createFromKtClass(klass: KtClassOrObject, resolutionFacade: ResolutionFacade): ClassSubstitutor? {
            val superTypes =
                klass.superTypeListEntries.map { superType ->
                    ...
                    (type.constructor.declarationDescriptor ?: return null) to
                            type.constructor.parameters.zip(typeReference.typeElement!!.typeArgumentsAsTypes) { parameter, argument ->
